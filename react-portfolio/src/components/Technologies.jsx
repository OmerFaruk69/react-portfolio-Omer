        ...
        className="flex flex-wrap items-center justify-center gap-4">
            ...
            <motion.div 
             ...
             initial = "initial"
              animate = "animate"
            className="relative rounded-2xl border-4 border-neutral-800 p-4 group">
                <FaRegSnowflake className="text-7xl" style={{ color: "#00A9E0" }} />
            ...
            initial = "initial"
             animate = "animate"
            className="relative rounded-2xl border-4 border-neutral-800 p-4 group">
                <SiMysql  className="text-7xl" style={{ color: "#00618D" }}/>
            ...
            <motion.div 
             ...
             animate = "animate"
            className="relative rounded-2xl border-4 border-neutral-800 p-4 group">
                <SiMicrosoftsqlserver className="text-7xl" style={{ color: "#CC2927"}}/>
...
<motion.div 
        ...
        className="flex flex-wrap items-center justify-center gap-4">
             ...
             initial = "initial"
              animate = "animate"
            className="relative rounded-2xl border-4 border-neutral-800 p-4 group">
                <SiPython className="text-7xl text-sky-700" style={{ color: "#3776AB" }}/>
            ...
            <motion.div 
             ...
             initial = "initial"
              animate = "animate"
            className="relative rounded-2xl border-4 border-neutral-800 p-4 group">
                <SiPowerbi className="text-7xl text-green-500" style={{ color: "#F2C811" }}/>
...
<motion.div 
        ...
        className="flex flex-wrap items-center justify-center gap-4">
             ...
             initial = "initial"
              animate = "animate"
            className="relative rounded-2xl border-4 border-neutral-800 p-4 group">
                <SiTalend className="text-7xl text-sky-700" style={{ color: "#0A5D81" }}/>
...
<motion.div 
        ...
        className="flex flex-wrap items-center justify-center gap-4">
             ...
             initial = "initial"
              animate = "animate"
            className="relative rounded-2xl border-4 border-neutral-800 p-4 group">
                <SiGitlab className="text-7xl text-sky-700" style={{ color: "#FC6D26" }}/>
            ...
            <motion.div 
             ...
             initial = "initial"
              animate = "animate"
            className="relative rounded-2xl border-4 border-neutral-800 p-4 group">
                <SiJenkins className="text-7xl" style={{ color: "#F06A00" }} />
